...
class IronRodCard extends StatelessWidget {
  final IronRods item;

  const IronRodCard({Key key, this.item}) : super(key: key);
  @override
      ...
      children: [
        Table(
          ...
          children: [
            ...
            TableRow(children: [
              Text('Diameter', style: kTextStyle),
              Text('${item.dia}', style: kTextStyle)
            ]),
            TableRow(children: [
              Text('Price Per Ton', style: kTextStyle),
