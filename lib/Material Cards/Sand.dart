...
class SandDataCard extends StatelessWidget {
  static String id = 'Sand Data Card';
          ...
          IconButton(
              ...
              onPressed: () async {
                try {
                  ...
                  await _storage.ref('Sand/$type.png').putFile(image);
                  url = await _storage.ref('Sand/$type.png').getDownloadURL();
                  await _firestore.collection('Sand').doc('$type').set(
                    {
                      'Image Url': url,
                      'type': type,
                      'Status': status,
